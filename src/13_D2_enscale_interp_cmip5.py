...
for index in indices:
    ...
    pt_path = f"/cluster/work/math/climate-downscaling/cordex-data/cordex-ALPS-allyear/samples_multivariate/maybritt_nicolai_zeros-constant_dec-1e-3_onehot/idx{index}_inter.pt"
    ...
    # Save the result
    save_path = f"../plotting_data/enscale/interp/{index}.npy"
