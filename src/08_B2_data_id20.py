...
file_pattern = "*id-020_sample-10*2030-2039*.nc"
...
for file_path in files:
    ...
    np.save(
        f"../plotting_data/corrdiff/per_file_id020/solar/{filename}.npy",
        rsds_counts_np,
    )
    np.save(
        f"../plotting_data/corrdiff/per_file_id020/wind/{filename}.npy",
        wind_counts_np,
    )
...
for file_path in files:
    ...
    filename = file_path.split("/")[-1].rsplit(".", 1)[0]
    np.save(
        f"../plotting_data/corrdiff/per_file_id020/solar/{filename}.npy", rsds_counts_np
    )
    np.save(
        f"../plotting_data/corrdiff/per_file_id020/wind/{filename}.npy", wind_counts_np
    )
