...
for index in range(start_index, end_index):
    ...
    pt_file_path = f"/cluster/work/math/climate-downscaling/cordex-data/cordex-ALPS-allyear/samples_multivariate/maybritt_nicolai_zeros-constant_dec-1e-3_onehot_cmip6/idx{index}_extra.pt"
    ...
    save_path = f"..plotting_data/enscale/extra/cmip6/{index}.npy"
