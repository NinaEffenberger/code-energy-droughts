...
data_folder = "/cluster/work/math/climate-downscaling/cordex-data/cordex-ALPS-allyear/cmip6/test/interpolation"
...
time_folder = "/cluster/work/math/climate-downscaling/cordex-data/cordex-ALPS-allyear/cmip6/test/interpolation"
...
for solar_file in solar_files:
    ...
    np.save("../plotting_data/CMIP6/GCM/past/" + model_name + ".npy", season_counts_np)
    gc.collect()
